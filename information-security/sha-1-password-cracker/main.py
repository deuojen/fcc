...
# print(cracked_password3, "sammy123")

# cracked_password3 = password_cracker.crack_sha1_hash(
#     "c7ab388a5ebefbf4d550652f1eb4d833e5316e3e")
# print(cracked_password3, "abacab")

# cracked_password3 = password_cracker.crack_sha1_hash(
#     "5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8")
# print(cracked_password3, "password")
...
print(cracked_password3, "superman")

cracked_password3 = password_cracker.crack_sha1_hash(
    "da5a4e8cf89539e66097acd2f8af128acae2f8ae", True)
print(cracked_password3, "q1w2e3r4t5")

cracked_password3 = password_cracker.crack_sha1_hash(
    "ea3f62d498e3b98557f9f9cd0d905028b3b019e1", True)
print(cracked_password3, "bubbles1")
